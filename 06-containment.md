...
## Objective 
During this stage, the defending team has to isolate the affected system (4ubrick) to prevent further exploitation of the SQL injection vulnerability identified in Stage 5, while preserving evidence for later analysis.
...
### Wazuh manager stops receiving traffic logs from attacker's IP address 
...
## Next Steps
Next phase 7 of the project covers Eradication & Recovery process. During this stage, the defending team will remove the vulnerability, and restore the affected systems. 
